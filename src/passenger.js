...
if (document.getElementById("ride-date")) {
...
if (reserveTab) reserveTab.addEventListener("click", () => setView("reserve"));
if (trackTab) trackTab.addEventListener("click", () => setView("track"));

if (document.getElementById("estimate-button")) {
